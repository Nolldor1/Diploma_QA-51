...
1. **Оплата картой:**
    **Открыть** [страницу](https://localhost:8080/) => кликнуть "Купить" (оплата картой) => в открывшемся окне в доступных полях ввести валидные номер карты, месяц, год, владелец и CVC/CVV => кликнуть кнопку "Продолжить";  
    `Результат:`
...
2. **Оплата в кредит:**
    **Открыть** [страницу](https://localhost:8080/) => кликнуть "Купить в кредит" => в открывшемся окне в доступных полях вести валидные номер карты, месяц, год, владелец и CVC/CVV => кликнуть кнопку "Продолжить";  
      `Результат:`
